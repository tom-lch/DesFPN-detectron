...
class SpotFPN(Backbone):
    ...
    """
    def __init__(self, bottom_up, in_features, out_channels, norm="", top_block=None, fuse_type="sum",pool_ratios=(0.1, 0.2, 0.3)):
...
def build_resnet_spotfpn_backbone():
    """
    Args:
